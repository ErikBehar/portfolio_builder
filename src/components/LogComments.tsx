...
export function LogComments({
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    const response = await fetch(`/api/log/${logEntryId}/comments`, {
      method: "POST",
  ...
  return (
    <section className="mt-12 border-t border-border pt-10">
      ...
      {commentsEnabled ? (
      <form onSubmit={handleSubmit} className="mt-8 space-y-4 rounded-xl border border-border bg-surface p-5">
